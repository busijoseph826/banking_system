...
public class Main {
    ...
    private static void manageAccounts(AdminService adminService, Scanner sc) {
        System.out.println(ColorCodes.colorize(ColorCodes.ITALIC+ColorCodes.BLACK+"1. Delete Account", ColorCodes.GREEN));
        System.out.println(ColorCodes.colorize(ColorCodes.ITALIC+ColorCodes.BLACK+"2. Lock Account", ColorCodes.GREEN));
        System.out.println(ColorCodes.colorize(ColorCodes.ITALIC+ColorCodes.BLACK+"3. Unlock Account", ColorCodes.GREEN));
        System.out.print(ColorCodes.colorize("Choose an option: ", ColorCodes.PURPLE));
